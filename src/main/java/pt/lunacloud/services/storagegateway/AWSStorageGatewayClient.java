 ...
 */
package pt.lunacloud.services.storagegateway;
...
import pt.lunacloud.services.storagegateway.model.*;
import pt.lunacloud.services.storagegateway.model.transform.*;
...
public class AWSStorageGatewayClient extends AmazonWebServiceClient implements AWSStorageGateway {
     ...
     */
    public AWSStorageGatewayClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSStorageGatewayClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AWSStorageGatewayClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSStorageGatewayClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
