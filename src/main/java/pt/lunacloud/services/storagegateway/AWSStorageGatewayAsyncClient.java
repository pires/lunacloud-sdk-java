...
public class AWSStorageGatewayAsyncClient extends AWSStorageGatewayClient
     ...
     */
    public AWSStorageGatewayAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AWSStorageGatewayAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AWSStorageGatewayAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AWSStorageGatewayAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
