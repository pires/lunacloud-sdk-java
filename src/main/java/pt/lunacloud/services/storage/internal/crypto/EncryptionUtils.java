 ...
 */
package pt.lunacloud.services.storage.internal.crypto;
...
import pt.lunacloud.services.storage.model.EncryptionMaterialsAccessor;
...
public class EncryptionUtils {
     ...
     */
    @Deprecated
    public static StorageObject decryptObjectUsingMetadata(StorageObject object, EncryptionMaterials materials, Provider cryptoProvider) {
     ...
     */
    @Deprecated
    public static EncryptionInstruction buildInstructionFromInstructionFile(StorageObject instructionFile, EncryptionMaterials materials, Provider cryptoProvider) {
     ...
     *      A non-null instruction object containing encryption information
     */
    public static EncryptionInstruction buildInstructionFromInstructionFile(StorageObject instructionFile, EncryptionMaterialsProvider materialsProvider, Provider cryptoProvider) {
     ...
     */
    @Deprecated
    public static EncryptionInstruction buildInstructionFromObjectMetadata(StorageObject object, EncryptionMaterials materials, Provider cryptoProvider) {
     ...
     *      materials used to encrypt the object are not available via the materials Accessor
     */
    public static EncryptionInstruction buildInstructionFromObjectMetadata(StorageObject object, EncryptionMaterialsProvider materialsProvider, Provider cryptoProvider) {
     ...
     *      The updated object where the object content input stream contains the decrypted contents.
     */
    public static StorageObject decryptObjectUsingInstruction(StorageObject object, EncryptionInstruction instruction) {
        StorageObjectInputStream objectContent = object.getObjectContent();
        InputStream decryptedInputStream = new CipherInputStream(objectContent, instruction.getSymmetricCipher());
        object.setObjectContent(new StorageObjectInputStream(decryptedInputStream, objectContent.getHttpRequest()));
        return object;
    }
     ...
     *      metadata, false otherwise.
     */
    public static boolean isEncryptionInfoInMetadata(StorageObject retrievedObject) {
     ...
     *      encryption info, false otherwise.
     */
    public static boolean isEncryptionInfoInInstructionFile(StorageObject instructionFile) {
     ...
     */
    public static StorageObject adjustOutputToDesiredRange(StorageObject object, long[] range) {
        if (range == null || range[0] > range[1]) {
     ...
     */
    private static JSONObject parseJSONInstruction(StorageObject instructionObject) {
        try {
