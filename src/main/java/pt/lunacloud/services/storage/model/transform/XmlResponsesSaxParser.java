...
import pt.lunacloud.services.storage.internal.ServerSideEncryptionResult;
...
import pt.lunacloud.services.storage.model.CORSRule;
import pt.lunacloud.services.storage.model.CanonicalGrantee;
...
import pt.lunacloud.services.storage.model.EmailAddressGrantee;
...
import pt.lunacloud.services.storage.model.PartSummary;
import pt.lunacloud.services.storage.model.Permission;
import pt.lunacloud.services.storage.model.RedirectRule;
import pt.lunacloud.services.storage.model.RoutingRule;
import pt.lunacloud.services.storage.model.RoutingRuleCondition;
import pt.lunacloud.services.storage.model.StorageObjectSummary;
import pt.lunacloud.services.storage.model.S3VersionSummary;
import pt.lunacloud.services.storage.model.StorageClass;
import pt.lunacloud.services.storage.model.StorageObject;
import pt.lunacloud.services.storage.model.TagSet;
import pt.lunacloud.services.storage.model.VersionListing;
import pt.lunacloud.services.storage.model.BucketLifecycleConfiguration.Rule;
import pt.lunacloud.services.storage.model.BucketLifecycleConfiguration.Transition;
import pt.lunacloud.services.storage.model.BucketNotificationConfiguration.TopicConfiguration;
import pt.lunacloud.services.storage.model.CORSRule.AllowedMethods;
...
public class XmlResponsesSaxParser {
	 ...
	 * into {@link StorageObject}s available via the {@link #getObjects()} method.
	 */
	public class ListBucketHandler extends DefaultHandler {
		private StorageObjectSummary currentObject = null;
		 ...
		 */
		public List<StorageObjectSummary> getObjects() {
		...
		public void startElement(String uri, String name, String qName,
			...
			if (name.equals("Contents")) {
				currentObject = new StorageObjectSummary();
	...
	public class CompleteMultipartUploadHandler extends DefaultHandler
		...
		/**
		 * @see pt.lunacloud.services.storage.model.CompleteMultipartUploadResult#getExpirationTime()
		 */
		public Date getExpirationTime() {
			if (result != null)
		...
		/**
		 * @see pt.lunacloud.services.storage.model.CompleteMultipartUploadResult#setExpirationTime(java.util.Date)
		 */
		public void setExpirationTime(Date expirationTime) {
			if (result != null)
		...
		/**
		 * @see pt.lunacloud.services.storage.model.CompleteMultipartUploadResult#getExpirationTimeRuleId()
		 */
		public String getExpirationTimeRuleId() {
			if (result != null)
		...
		/**
		 * @see pt.lunacloud.services.storage.model.CompleteMultipartUploadResult#setExpirationTimeRuleId(java.lang.String)
		 */
		public void setExpirationTimeRuleId(String expirationTimeRuleId) {
			if (result != null)
