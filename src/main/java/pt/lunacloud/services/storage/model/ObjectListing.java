 ...
 * This includes
 * a list of {@link StorageObjectSummary} objects describing the objects stored in
 ...
 * 
 * @see LunacloudStorage#listObjects(String, String)
 * @see LunacloudStorage#listObjects(ListObjectsRequest)
 * @see LunacloudStorage#listNextBatchOfObjects(ObjectListing)
 */
public class ObjectListing {
    
    /** A list of summary information describing the objects stored in the bucket */
    private List<StorageObjectSummary> objectSummaries = new ArrayList<StorageObjectSummary>();
     ...
     * additional calls to
     * {@link LunacloudStorage#listNextBatchOfObjects(ObjectListing)} to get
     * additional results.
     * 
