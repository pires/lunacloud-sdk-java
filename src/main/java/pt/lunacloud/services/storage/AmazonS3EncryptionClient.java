...
import pt.lunacloud.services.storage.internal.crypto.ByteRangeCapturingInputStream;
import pt.lunacloud.services.storage.internal.crypto.EncryptedUploadContext;
import pt.lunacloud.services.storage.internal.crypto.EncryptionInstruction;
import pt.lunacloud.services.storage.internal.crypto.EncryptionUtils;
import pt.lunacloud.services.storage.internal.crypto.JceEncryptionConstants;
...
import pt.lunacloud.services.storage.model.CryptoConfiguration;
import pt.lunacloud.services.storage.model.CryptoStorageMode;
import pt.lunacloud.services.storage.model.DeleteObjectRequest;
import pt.lunacloud.services.storage.model.EncryptionMaterials;
import pt.lunacloud.services.storage.model.EncryptionMaterialsProvider;
...
import pt.lunacloud.services.storage.model.StaticEncryptionMaterialsProvider;
...
import pt.lunacloud.services.storage.transfer.TransferManager;
...
public class AmazonS3EncryptionClient extends LunacloudStorageClient {
    ...
    throws AmazonClientException, AmazonServiceException {
        ...
        StorageObject retrievedObject = super.getObject(getObjectRequest);
        ...
        StorageObject objectToBeReturned;
        ...
        if (EncryptionUtils.isEncryptionInfoInMetadata(retrievedObject)) {
            ...
            StorageObject instructionFile = getInstructionFile(getObjectRequest);
     ...
     */
    private StorageObject decryptObjectUsingMetadata(StorageObject object) {
     ...
     */
    private StorageObject decryptObjectUsingInstructionFile(StorageObject object, StorageObject instructionFile) {
     ...
     */
    private StorageObject getInstructionFile(GetObjectRequest getObjectRequest) {
        try {
