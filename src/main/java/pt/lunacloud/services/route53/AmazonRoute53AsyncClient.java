...
public class AmazonRoute53AsyncClient extends AmazonRoute53Client
     ...
     */
    public AmazonRoute53AsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonRoute53AsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonRoute53AsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonRoute53AsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
