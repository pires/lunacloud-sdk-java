 ...
 */
package pt.lunacloud.services.route53;
...
import pt.lunacloud.services.route53.model.*;
import pt.lunacloud.services.route53.model.transform.*;
...
public class AmazonRoute53Client extends AmazonWebServiceClient implements AmazonRoute53 {
     ...
     */
    public AmazonRoute53Client(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonRoute53Client(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonRoute53Client(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonRoute53Client(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
