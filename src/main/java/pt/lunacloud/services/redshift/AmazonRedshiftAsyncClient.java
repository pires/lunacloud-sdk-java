...
public class AmazonRedshiftAsyncClient extends AmazonRedshiftClient
     ...
     */
    public AmazonRedshiftAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonRedshiftAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonRedshiftAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonRedshiftAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
