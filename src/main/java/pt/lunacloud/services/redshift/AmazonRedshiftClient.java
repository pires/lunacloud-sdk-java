 ...
 */
package pt.lunacloud.services.redshift;
...
import pt.lunacloud.services.redshift.model.transform.*;
...
public class AmazonRedshiftClient extends AmazonWebServiceClient implements AmazonRedshift {
     ...
     */
    public AmazonRedshiftClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonRedshiftClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonRedshiftClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonRedshiftClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
