...
public class AmazonEC2AsyncClient extends AmazonEC2Client
     ...
     */
    public AmazonEC2AsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonEC2AsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonEC2AsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonEC2AsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
