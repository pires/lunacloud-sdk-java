...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.ec2.AmazonEC2#describeRegions(DescribeRegionsRequest) DescribeRegions operation}.
 * <p>
 * The DescribeRegions operation describes regions zones that are currently available to the account.
 * </p>
 *
 * @see pt.lunacloud.services.ec2.AmazonEC2#describeRegions(DescribeRegionsRequest)
 */
