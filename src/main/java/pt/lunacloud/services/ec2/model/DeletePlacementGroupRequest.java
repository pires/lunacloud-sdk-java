...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.ec2.AmazonEC2#deletePlacementGroup(DeletePlacementGroupRequest) DeletePlacementGroup operation}.
 * <p>
 * Deletes a PlacementGroup from a user's account. Terminate all Amazon EC2 instances in the placement group before deletion.
 * </p>
 *
 * @see pt.lunacloud.services.ec2.AmazonEC2#deletePlacementGroup(DeletePlacementGroupRequest)
 */
