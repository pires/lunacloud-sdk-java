...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.ec2.AmazonEC2#deleteVolume(DeleteVolumeRequest) DeleteVolume operation}.
 * <p>
 * Deletes a previously created volume. Once successfully deleted, a new volume can be created with the same name.
 * </p>
 *
 * @see pt.lunacloud.services.ec2.AmazonEC2#deleteVolume(DeleteVolumeRequest)
 */
