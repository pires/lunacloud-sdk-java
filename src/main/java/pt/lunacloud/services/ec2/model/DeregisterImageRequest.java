...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.ec2.AmazonEC2#deregisterImage(DeregisterImageRequest) DeregisterImage operation}.
 * <p>
 * The DeregisterImage operation deregisters an AMI. Once deregistered, instances of the AMI can no longer be launched.
 * </p>
 *
 * @see pt.lunacloud.services.ec2.AmazonEC2#deregisterImage(DeregisterImageRequest)
 */
