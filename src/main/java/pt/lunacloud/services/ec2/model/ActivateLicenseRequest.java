...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.ec2.AmazonEC2#activateLicense(ActivateLicenseRequest) ActivateLicense operation}.
 * <p>
 * Activates a specific number of licenses for a 90-day period. Activations can be done against a specific license ID.
 * </p>
 *
 * @see pt.lunacloud.services.ec2.AmazonEC2#activateLicense(ActivateLicenseRequest)
 */
