 ...
 */
package pt.lunacloud.services.ec2;
...
import pt.lunacloud.services.ec2.model.transform.*;
import pt.lunacloud.transform.LegacyErrorUnmarshaller;
...
public class AmazonEC2Client extends AmazonWebServiceClient implements AmazonEC2 {
     ...
     */
    public AmazonEC2Client(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonEC2Client(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonEC2Client(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonEC2Client(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
