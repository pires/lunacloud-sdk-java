...
public class AmazonAutoScalingAsyncClient extends AmazonAutoScalingClient
     ...
     */
    public AmazonAutoScalingAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonAutoScalingAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonAutoScalingAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonAutoScalingAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
