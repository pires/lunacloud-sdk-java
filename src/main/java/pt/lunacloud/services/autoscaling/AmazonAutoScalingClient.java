 ...
 */
package pt.lunacloud.services.autoscaling;
...
import pt.lunacloud.services.autoscaling.model.transform.*;
...
public class AmazonAutoScalingClient extends AmazonWebServiceClient implements AmazonAutoScaling {
     ...
     */
    public AmazonAutoScalingClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonAutoScalingClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonAutoScalingClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonAutoScalingClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
