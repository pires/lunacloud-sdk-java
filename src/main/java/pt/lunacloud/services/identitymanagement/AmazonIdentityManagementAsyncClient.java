...
public class AmazonIdentityManagementAsyncClient extends AmazonIdentityManagementClient
     ...
     */
    public AmazonIdentityManagementAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonIdentityManagementAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonIdentityManagementAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonIdentityManagementAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
