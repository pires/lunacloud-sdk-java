...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.identitymanagement.AmazonIdentityManagement#getLoginProfile(GetLoginProfileRequest) GetLoginProfile operation}.
 * <p>
 * Retrieves the user name and password create date for the specified user.
 * </p>
 *
 * @see pt.lunacloud.services.identitymanagement.AmazonIdentityManagement#getLoginProfile(GetLoginProfileRequest)
 */
