 ...
 */
package pt.lunacloud.services.identitymanagement;
...
import pt.lunacloud.services.identitymanagement.model.transform.*;
...
public class AmazonIdentityManagementClient extends AmazonWebServiceClient implements AmazonIdentityManagement {
     ...
     */
    public AmazonIdentityManagementClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonIdentityManagementClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonIdentityManagementClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonIdentityManagementClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
