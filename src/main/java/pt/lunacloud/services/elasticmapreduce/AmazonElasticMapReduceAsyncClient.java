...
public class AmazonElasticMapReduceAsyncClient extends AmazonElasticMapReduceClient
     ...
     */
    public AmazonElasticMapReduceAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonElasticMapReduceAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonElasticMapReduceAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonElasticMapReduceAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
