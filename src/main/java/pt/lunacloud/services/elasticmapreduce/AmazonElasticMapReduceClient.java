 ...
 */
package pt.lunacloud.services.elasticmapreduce;
...
import pt.lunacloud.http.DefaultErrorResponseHandler;
import pt.lunacloud.http.ExecutionContext;
import pt.lunacloud.http.StaxResponseHandler;
import pt.lunacloud.internal.StaticCredentialsProvider;
import pt.lunacloud.services.elasticmapreduce.model.*;
import pt.lunacloud.services.elasticmapreduce.model.transform.*;
...
public class AmazonElasticMapReduceClient extends AmazonWebServiceClient implements AmazonElasticMapReduce {
     ...
     */
    public AmazonElasticMapReduceClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonElasticMapReduceClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonElasticMapReduceClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonElasticMapReduceClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
