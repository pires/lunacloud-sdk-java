 ...
 */
package pt.lunacloud.services.cloudwatch;
...
import pt.lunacloud.services.cloudwatch.model.*;
import pt.lunacloud.services.cloudwatch.model.transform.*;
...
public class AmazonCloudWatchClient extends AmazonWebServiceClient implements AmazonCloudWatch {
     ...
     */
    public AmazonCloudWatchClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCloudWatchClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonCloudWatchClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonCloudWatchClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
