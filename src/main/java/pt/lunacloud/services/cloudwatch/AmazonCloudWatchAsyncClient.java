...
public class AmazonCloudWatchAsyncClient extends AmazonCloudWatchClient
     ...
     */
    public AmazonCloudWatchAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonCloudWatchAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonCloudWatchAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonCloudWatchAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
