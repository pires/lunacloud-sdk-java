 ...
 */
package pt.lunacloud.services.cloudwatch.model;
import pt.lunacloud.AmazonWebServiceRequest;

/**
 * Container for the parameters to the {@link pt.lunacloud.services.cloudwatch.AmazonCloudWatch#describeAlarmsForMetric(DescribeAlarmsForMetricRequest) DescribeAlarmsForMetric operation}.
 * <p>
 * Retrieves all alarms for a single metric. Specify a statistic, period, or unit to filter the set of alarms further.
 * </p>
 *
 * @see pt.lunacloud.services.cloudwatch.AmazonCloudWatch#describeAlarmsForMetric(DescribeAlarmsForMetricRequest)
 */
