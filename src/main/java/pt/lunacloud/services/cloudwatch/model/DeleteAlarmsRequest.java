...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.cloudwatch.AmazonCloudWatch#deleteAlarms(DeleteAlarmsRequest) DeleteAlarms operation}.
 * <p>
 * Deletes all specified alarms. In the event of an error, no alarms are deleted.
 * </p>
 *
 * @see pt.lunacloud.services.cloudwatch.AmazonCloudWatch#deleteAlarms(DeleteAlarmsRequest)
 */
