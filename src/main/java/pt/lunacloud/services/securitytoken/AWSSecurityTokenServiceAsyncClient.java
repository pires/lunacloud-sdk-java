...
public class AWSSecurityTokenServiceAsyncClient extends AWSSecurityTokenServiceClient
     ...
     */
    public AWSSecurityTokenServiceAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AWSSecurityTokenServiceAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AWSSecurityTokenServiceAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AWSSecurityTokenServiceAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
