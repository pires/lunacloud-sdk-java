...
public class AmazonDirectConnectAsyncClient extends AmazonDirectConnectClient
     ...
     */
    public AmazonDirectConnectAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonDirectConnectAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonDirectConnectAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonDirectConnectAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
