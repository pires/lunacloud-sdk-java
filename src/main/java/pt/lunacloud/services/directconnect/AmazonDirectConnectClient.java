 ...
 */
package pt.lunacloud.services.directconnect;
...
import pt.lunacloud.services.directconnect.model.transform.*;
...
public class AmazonDirectConnectClient extends AmazonWebServiceClient implements AmazonDirectConnect {
     ...
     */
    public AmazonDirectConnectClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonDirectConnectClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonDirectConnectClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonDirectConnectClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
