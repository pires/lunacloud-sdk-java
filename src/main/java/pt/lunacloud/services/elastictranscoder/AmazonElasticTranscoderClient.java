 ...
 */
package pt.lunacloud.services.elastictranscoder;
...
import pt.lunacloud.http.JsonErrorResponseHandler;
import pt.lunacloud.http.JsonResponseHandler;
import pt.lunacloud.internal.StaticCredentialsProvider;
import pt.lunacloud.services.elastictranscoder.model.*;
import pt.lunacloud.services.elastictranscoder.model.transform.*;
import pt.lunacloud.transform.JsonErrorUnmarshaller;
import pt.lunacloud.transform.JsonUnmarshallerContext;
...
public class AmazonElasticTranscoderClient extends AmazonWebServiceClient implements AmazonElasticTranscoder {
     ...
     */
    public AmazonElasticTranscoderClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonElasticTranscoderClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonElasticTranscoderClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonElasticTranscoderClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
