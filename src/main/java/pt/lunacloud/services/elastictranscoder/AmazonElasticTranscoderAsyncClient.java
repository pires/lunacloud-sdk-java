...
import pt.lunacloud.auth.DefaultAWSCredentialsProviderChain;
...
public class AmazonElasticTranscoderAsyncClient extends AmazonElasticTranscoderClient
     ...
     */
    public AmazonElasticTranscoderAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonElasticTranscoderAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonElasticTranscoderAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonElasticTranscoderAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
