...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.elastictranscoder.AmazonElasticTranscoder#createPipeline(CreatePipelineRequest) CreatePipeline operation}.
 * <p>
 * To create a pipeline, send a POST request to the <code>2012-09-25/pipelines</code> resource.
 * </p>
 *
 * @see pt.lunacloud.services.elastictranscoder.AmazonElasticTranscoder#createPipeline(CreatePipelineRequest)
 */
