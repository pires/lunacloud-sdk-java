 ...
 */
package pt.lunacloud.services.elasticbeanstalk;
...
import pt.lunacloud.services.elasticbeanstalk.model.transform.*;
...
public class AWSElasticBeanstalkClient extends AmazonWebServiceClient implements AWSElasticBeanstalk {
     ...
     */
    public AWSElasticBeanstalkClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSElasticBeanstalkClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AWSElasticBeanstalkClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSElasticBeanstalkClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
