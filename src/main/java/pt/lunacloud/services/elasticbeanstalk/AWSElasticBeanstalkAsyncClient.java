...
public class AWSElasticBeanstalkAsyncClient extends AWSElasticBeanstalkClient
     ...
     */
    public AWSElasticBeanstalkAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AWSElasticBeanstalkAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AWSElasticBeanstalkAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AWSElasticBeanstalkAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
