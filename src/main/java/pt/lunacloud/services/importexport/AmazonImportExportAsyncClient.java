...
public class AmazonImportExportAsyncClient extends AmazonImportExportClient
     ...
     */
    public AmazonImportExportAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonImportExportAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonImportExportAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonImportExportAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
