 ...
 */
package pt.lunacloud.services.importexport;
...
import pt.lunacloud.services.importexport.model.transform.*;
...
public class AmazonImportExportClient extends AmazonWebServiceClient implements AmazonImportExport {
     ...
     */
    public AmazonImportExportClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonImportExportClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonImportExportClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonImportExportClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
