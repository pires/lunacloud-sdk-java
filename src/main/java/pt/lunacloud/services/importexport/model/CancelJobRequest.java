...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.importexport.AmazonImportExport#cancelJob(CancelJobRequest) CancelJob operation}.
 * <p>
 * This operation cancels a specified job. Only the job owner can cancel it. The operation fails if the job has already started or is complete.
 * </p>
 *
 * @see pt.lunacloud.services.importexport.AmazonImportExport#cancelJob(CancelJobRequest)
 */
