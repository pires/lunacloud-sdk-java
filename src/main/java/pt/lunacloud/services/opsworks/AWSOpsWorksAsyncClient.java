...
public class AWSOpsWorksAsyncClient extends AWSOpsWorksClient
     ...
     */
    public AWSOpsWorksAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AWSOpsWorksAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AWSOpsWorksAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AWSOpsWorksAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
