...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.opsworks.AWSOpsWorks#getHostnameSuggestion(GetHostnameSuggestionRequest) GetHostnameSuggestion operation}.
 * <p>
 * Gets a generated hostname for the specified layer, based on the current hostname theme.
 * </p>
 *
 * @see pt.lunacloud.services.opsworks.AWSOpsWorks#getHostnameSuggestion(GetHostnameSuggestionRequest)
 */
