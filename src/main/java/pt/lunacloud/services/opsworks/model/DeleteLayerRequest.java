...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.opsworks.AWSOpsWorks#deleteLayer(DeleteLayerRequest) DeleteLayer operation}.
 * <p>
 * Deletes a specified layer. You must first remove all associated instances.
 * </p>
 *
 * @see pt.lunacloud.services.opsworks.AWSOpsWorks#deleteLayer(DeleteLayerRequest)
 */
