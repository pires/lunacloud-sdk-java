...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.opsworks.AWSOpsWorks#describePermissions(DescribePermissionsRequest) DescribePermissions operation}.
 * <p>
 * Describes the permissions for a specified stack. You must specify at least one of the two request values.
 * </p>
 *
 * @see pt.lunacloud.services.opsworks.AWSOpsWorks#describePermissions(DescribePermissionsRequest)
 */
