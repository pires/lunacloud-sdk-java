 ...
 */
package pt.lunacloud.services.opsworks;
...
import pt.lunacloud.services.opsworks.model.transform.*;
...
public class AWSOpsWorksClient extends AmazonWebServiceClient implements AWSOpsWorks {
     ...
     */
    public AWSOpsWorksClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSOpsWorksClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AWSOpsWorksClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AWSOpsWorksClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
