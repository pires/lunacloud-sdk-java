 ...
 */
package pt.lunacloud.services.datapipeline;
...
import pt.lunacloud.services.datapipeline.model.transform.*;
...
public class DataPipelineClient extends AmazonWebServiceClient implements DataPipeline {
     ...
     */
    public DataPipelineClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public DataPipelineClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public DataPipelineClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public DataPipelineClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
