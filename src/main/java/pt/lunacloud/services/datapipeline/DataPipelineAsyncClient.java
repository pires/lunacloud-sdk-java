...
public class DataPipelineAsyncClient extends DataPipelineClient
     ...
     */
    public DataPipelineAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public DataPipelineAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public DataPipelineAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public DataPipelineAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
