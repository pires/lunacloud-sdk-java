 ...
 */
package pt.lunacloud.services.datapipeline.model;
import pt.lunacloud.AmazonWebServiceRequest;

/**
 * Container for the parameters to the {@link pt.lunacloud.services.datapipeline.DataPipeline#validatePipelineDefinition(ValidatePipelineDefinitionRequest) ValidatePipelineDefinition operation}.
 * <p>
 * Tests the pipeline definition with a set of validation checks to ensure that it is well formed and can run without error.
 * </p>
 *
 * @see pt.lunacloud.services.datapipeline.DataPipeline#validatePipelineDefinition(ValidatePipelineDefinitionRequest)
 */
