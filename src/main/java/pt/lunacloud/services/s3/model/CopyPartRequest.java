 ...
 */
package pt.lunacloud.services.s3.model;
 ...
 * 
 * @see LunacloudStorageClient#copyObject(com.amazonaws.services.s3.model.CopyPartRequest)
 * @see LunacloudStorageClient#initiateMultipartUpload(InitiateMultipartUploadRequest)
 * @see LunacloudStorageClient#uploadPart(UploadPartRequest)
 * @see CopyPartResult
 */
public class CopyPartRequest extends AmazonWebServiceRequest {
     ...
     * 
     * @see LunacloudStorage#uploadPart(UploadPartRequest)
     */
     ...
     * {@link LunacloudStorage#withBucketVersioningConfiguration(withBucketVersioningConfigurationRequest)}.
     */
     ...
     * <p>
     * For more information about enabling versioning for a bucket, see
     * {@link LunacloudStorage#setBucketVersioningConfiguration(SetBucketVersioningConfigurationRequest)}
     * .
     * </p>
     * 
