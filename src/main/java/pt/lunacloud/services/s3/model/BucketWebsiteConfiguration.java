 ...
 *
 * @see LunacloudStorage#setBucketWebsiteConfiguration(String, BucketWebsiteConfiguration)
 * @see LunacloudStorage#getBucketWebsiteConfiguration(String)
 * @see LunacloudStorage#deleteBucketWebsiteConfiguration(String)
 */
