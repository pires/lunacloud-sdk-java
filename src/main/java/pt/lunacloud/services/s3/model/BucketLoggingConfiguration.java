 ...
 * {@link LunacloudStorageClient#setBucketLoggingConfiguration(SetBucketLoggingConfigurationRequest)}
 * and the current status of server access logging for a bucket can be retrieved
 * through {@link LunacloudStorageClient#getBucketLoggingConfiguration(String)}
 *
...
public class BucketLoggingConfiguration {
     ...
     * {@link LunacloudStorage#setBucketLoggingConfiguration(SetBucketLoggingConfigurationRequest)}
