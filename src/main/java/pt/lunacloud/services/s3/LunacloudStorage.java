 ...
 * </p>
 */
public interface LunacloudStorage {
     ...
     * {@link pt.lunacloud.ClientConfiguration} is used.
     * </p>
     * @param endpoint
     ...
     * {@link LunacloudStorageClient#listNextBatchOfObjects(ObjectListing)} method as
     ...
     *             request.
     *
     * @see LunacloudStorageClient#listObjects(String)
     * @see LunacloudStorageClient#listObjects(ListObjectsRequest)
     */
     ...
     * encouraged to use
     * {@link LunacloudStorage#listNextBatchOfVersions(VersionListing)} as an easy way
     ...
     *             request.
     *
     * @see LunacloudStorageClient#listVersions(ListVersionsRequest)
     ...
     *             request.
     *
     * @see LunacloudStorageClient#listVersions(String, String)
     * @see LunacloudStorageClient#listVersions(ListVersionsRequest)
     * @see LunacloudStorageClient#listVersions(String, String, String, String, String, Integer)
     */
     ...
     *            convenience method
     *            {@link LunacloudStorage#listNextBatchOfVersions(VersionListing)}
     ...
     *             request.
     *
     * @see pt.lunacloud.services.s3.model.Region
     */
     ...
     * {@link LunacloudStorageClient#getObjectAcl(String, String)}), modify it as
     ...
     *             request.
     *
     * @see LunacloudStorage#setObjectAcl(String, String, CannedAccessControlList)
     ...
     *             request.
     *
     * @see LunacloudStorage#setObjectAcl(String, String, AccessControlList)
     * @see LunacloudStorage#setObjectAcl(String, String, String, AccessControlList)
     * @see LunacloudStorage#setObjectAcl(String, String, String, CannedAccessControlList)
     */
     ...
     * bucket ( {@link LunacloudStorageClient#getBucketAcl(String)}), modify it as
     * necessary, and then use this method to upload the new ACL.
     *
     ...
     * {@link LunacloudStorageClient#getBucketAcl(String)}), modify it as necessary, and
     ...
     * use the simpler {@link LunacloudStorage#getObject(String bucketName, String key)} method.
     * </p>
     *
     ...
     * <p>
     * Instead of
     * using {@link LunacloudStorage#getObject(GetObjectRequest)},
     ...
     * {@link LunacloudStorage#deleteVersion(String, String, String)}.
     * </p>
     ...
     *             request.
     *
     * @see LunacloudStorage#putObject(String, String, File)
     ...
     *             request.
     *
     * @see LunacloudStorage#putObject(PutObjectRequest)
     * @see LunacloudStorage#putObject(String, String, InputStream, ObjectMetadata)
     */
     ...
     * {@link LunacloudStorageClient#copyObject(CopyObjectRequest)} method, including
     ...
     * {@link LunacloudStorageClient#copyObject(String, String, String, String)}
     * method.
     * </p>
     *
