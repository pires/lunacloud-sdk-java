 ...
 */
package pt.lunacloud.services.s3.transfer;
...
import pt.lunacloud.services.s3.AmazonS3EncryptionClient;
...
import pt.lunacloud.services.s3.transfer.Transfer.TransferState;
import pt.lunacloud.services.s3.transfer.internal.DownloadImpl;
import pt.lunacloud.services.s3.transfer.internal.DownloadMonitor;
import pt.lunacloud.services.s3.transfer.internal.MultipleFileDownloadImpl;
import pt.lunacloud.services.s3.transfer.internal.MultipleFileTransfer;
import pt.lunacloud.services.s3.transfer.internal.MultipleFileTransferMonitor;
import pt.lunacloud.services.s3.transfer.internal.MultipleFileUploadImpl;
import pt.lunacloud.services.s3.transfer.internal.ProgressListenerChain;
import pt.lunacloud.services.s3.transfer.internal.TransferManagerUtils;
import pt.lunacloud.services.s3.transfer.internal.TransferProgressImpl;
import pt.lunacloud.services.s3.transfer.internal.TransferProgressUpdatingListener;
import pt.lunacloud.services.s3.transfer.internal.TransferStateChangeListener;
import pt.lunacloud.services.s3.transfer.internal.UploadCallable;
import pt.lunacloud.services.s3.transfer.internal.UploadImpl;
import pt.lunacloud.services.s3.transfer.internal.UploadMonitor;
	...
	public MultipleFileDownload downloadDirectory(String bucketName,
		...
		do {
			...
			do {
				...
				for (S3ObjectSummary s : listObjectsResponse
				        .getObjectSummaries()) {
