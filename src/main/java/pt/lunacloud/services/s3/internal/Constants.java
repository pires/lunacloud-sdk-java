...
/**
 * Constants used by the Lunacloud Storage Java client.
 */
public class Constants {

	/** Default hostname for the Lunacloud Storage service endpoint */
	public static String LUNACLOUD_STORAGE_HOSTNAME = "http://lcs.lunacloud.com";

	/** Service name for Lunacloud Storage */
	public static String STORAGE_SERVICE_NAME = "Lunacloud Storage";
