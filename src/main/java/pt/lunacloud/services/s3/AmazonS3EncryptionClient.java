...
import pt.lunacloud.services.s3.internal.crypto.ByteRangeCapturingInputStream;
import pt.lunacloud.services.s3.internal.crypto.EncryptedUploadContext;
import pt.lunacloud.services.s3.internal.crypto.EncryptionInstruction;
import pt.lunacloud.services.s3.internal.crypto.EncryptionUtils;
import pt.lunacloud.services.s3.internal.crypto.JceEncryptionConstants;
...
import pt.lunacloud.services.s3.model.CryptoConfiguration;
import pt.lunacloud.services.s3.model.CryptoStorageMode;
import pt.lunacloud.services.s3.model.DeleteObjectRequest;
import pt.lunacloud.services.s3.model.EncryptionMaterials;
import pt.lunacloud.services.s3.model.EncryptionMaterialsProvider;
...
import pt.lunacloud.services.s3.model.StaticEncryptionMaterialsProvider;
import pt.lunacloud.services.s3.model.UploadPartRequest;
import pt.lunacloud.services.s3.model.UploadPartResult;
import pt.lunacloud.services.s3.transfer.TransferManager;
 ...
 */
public class AmazonS3EncryptionClient extends LunacloudStorageClient {
    ...
    public AmazonS3EncryptionClient(EncryptionMaterialsProvider encryptionMaterialsProvider) {
        this((LunacloudCredentialsProvider)null, encryptionMaterialsProvider, new ClientConfiguration(), new CryptoConfiguration());
    }
    ...
    public AmazonS3EncryptionClient(EncryptionMaterialsProvider encryptionMaterialsProvider,
        ...
        this((LunacloudCredentialsProvider)null, encryptionMaterialsProvider, new ClientConfiguration(), cryptoConfig);
    }
     ...
     *            The encryption materials to be used to encrypt and decrypt data.
     */
    public AmazonS3EncryptionClient(LunacloudCredentials credentials, EncryptionMaterials encryptionMaterials) {
     ...
     *            A provider for the encryption materials to be used to encrypt and decrypt data.
     */
    public AmazonS3EncryptionClient(LunacloudCredentials credentials, EncryptionMaterialsProvider encryptionMaterialsProvider) {
     ...
     *            A provider for the encryption materials to be used to encrypt and decrypt data.
     */
    public AmazonS3EncryptionClient(LunacloudCredentialsProvider credentialsProvider, EncryptionMaterialsProvider encryptionMaterialsProvider) {
     ...
     *            The crypto configuration whose parameters will be used to encrypt and decrypt data.
     */
    public AmazonS3EncryptionClient(LunacloudCredentials credentials,
     ...
     *            The crypto configuration whose parameters will be used to encrypt and decrypt data.
     */
    public AmazonS3EncryptionClient(LunacloudCredentialsProvider credentialsProvider,
            EncryptionMaterialsProvider encryptionMaterialsProvider, CryptoConfiguration cryptoConfig) {
