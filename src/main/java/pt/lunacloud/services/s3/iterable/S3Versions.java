 ...
 */
package pt.lunacloud.services.s3.iterable;
 ...
 * 
 * <pre>
 * for (S3VersionSummary summary : S3Versions
 *         .forPrefix(s3, &quot;my-bucket&quot;, &quot;photos/&quot;)) {
...
public class S3Versions implements Iterable<S3VersionSummary> {
	...
	private S3Versions(LunacloudStorage s3, String bucketName) {
		this.s3 = s3;
	 ...
	 */
	public static S3Versions inBucket(LunacloudStorage s3, String bucketName) {
	 ...
	 * @return An iterator for object version summaries.
	 */
	public static S3Versions withPrefix(LunacloudStorage s3, String bucketName,
	        String prefix) {
	 ...
	 * @return An iterator for object version summaries.
	 */
	public static S3Versions forKey(LunacloudStorage s3, String bucketName,
	        String key) {
		S3Versions versions = new S3Versions(s3, bucketName);
		versions.key = key;
		return versions;
