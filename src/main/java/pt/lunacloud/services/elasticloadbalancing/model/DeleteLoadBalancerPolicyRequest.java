...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.elasticloadbalancing.AmazonElasticLoadBalancing#deleteLoadBalancerPolicy(DeleteLoadBalancerPolicyRequest) DeleteLoadBalancerPolicy operation}.
 * <p>
 * Deletes a policy from the LoadBalancer. The specified policy must not be enabled for any listeners.
 * </p>
 *
 * @see pt.lunacloud.services.elasticloadbalancing.AmazonElasticLoadBalancing#deleteLoadBalancerPolicy(DeleteLoadBalancerPolicyRequest)
 */
