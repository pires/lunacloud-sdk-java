...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.elasticloadbalancing.AmazonElasticLoadBalancing#configureHealthCheck(ConfigureHealthCheckRequest) ConfigureHealthCheck operation}.
 * <p>
 * Enables the client to define an application healthcheck for the instances.
 * </p>
 *
 * @see pt.lunacloud.services.elasticloadbalancing.AmazonElasticLoadBalancing#configureHealthCheck(ConfigureHealthCheckRequest)
 */
