...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.rds.AmazonRDS#createDBSnapshot(CreateDBSnapshotRequest) CreateDBSnapshot operation}.
 * <p>
 * Creates a DBSnapshot. The source DBInstance must be in "available" state.
 * </p>
 *
 * @see pt.lunacloud.services.rds.AmazonRDS#createDBSnapshot(CreateDBSnapshotRequest)
 */
