...
public class DescribeOptionGroupsResultStaxUnmarshaller implements Unmarshaller<DescribeOptionGroupsResult, StaxUnmarshallerContext> {
    ...
    public DescribeOptionGroupsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeOptionGroupsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("OptionGroupsList/OptionGroup", targetDepth)) {
                    describeOptionGroupsResult.getOptionGroupsList().add(OptionGroupStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeOptionGroupsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeOptionGroupsResultStaxUnmarshaller();
        return instance;
    }
}
