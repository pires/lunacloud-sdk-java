...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.rds.AmazonRDS#copyDBSnapshot(CopyDBSnapshotRequest) CopyDBSnapshot operation}.
 * <p>
 * Copies the specified DBSnapshot. The source DBSnapshot must be in the "available" state.
 * </p>
 *
 * @see pt.lunacloud.services.rds.AmazonRDS#copyDBSnapshot(CopyDBSnapshotRequest)
 */
