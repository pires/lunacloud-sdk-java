...
public class DescribeReservedDBInstancesOfferingsResultStaxUnmarshaller implements Unmarshaller<DescribeReservedDBInstancesOfferingsResult, StaxUnmarshallerContext> {
    ...
    public DescribeReservedDBInstancesOfferingsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeReservedDBInstancesOfferingsResult;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ReservedDBInstancesOfferings/ReservedDBInstancesOffering", targetDepth)) {
                    describeReservedDBInstancesOfferingsResult.getReservedDBInstancesOfferings().add(ReservedDBInstancesOfferingStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeReservedDBInstancesOfferingsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeReservedDBInstancesOfferingsResultStaxUnmarshaller();
        return instance;
    }
}
