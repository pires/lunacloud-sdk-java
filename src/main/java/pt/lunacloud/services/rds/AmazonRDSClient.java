 ...
 */
package pt.lunacloud.services.rds;
...
import pt.lunacloud.services.rds.model.transform.*;
...
public class AmazonRDSClient extends AmazonWebServiceClient implements AmazonRDS {
     ...
     */
    public AmazonRDSClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonRDSClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonRDSClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonRDSClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
