...
public class AmazonRDSAsyncClient extends AmazonRDSClient
     ...
     */
    public AmazonRDSAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonRDSAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonRDSAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonRDSAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
