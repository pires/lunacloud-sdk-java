...
/**
 * Container for the parameters to the {@link pt.lunacloud.services.elasticache.AmazonElastiCache#describeReservedCacheNodes(DescribeReservedCacheNodesRequest) DescribeReservedCacheNodes operation}.
 * <p>
 * Returns information about reserved Cache Nodes for this account, or about a specified reserved Cache Node.
 * </p>
 *
 * @see pt.lunacloud.services.elasticache.AmazonElastiCache#describeReservedCacheNodes(DescribeReservedCacheNodesRequest)
 */
public class DescribeReservedCacheNodesRequest extends AmazonWebServiceRequest {
     ...
     * reservation ID.
     *
     * @return The reserved Cache Node identifier filter value. Specify this
     *         parameter to show only the reservation that matches the specified
     *         reservation ID.
     */
