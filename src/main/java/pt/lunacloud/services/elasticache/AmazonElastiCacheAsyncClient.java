...
public class AmazonElastiCacheAsyncClient extends AmazonElastiCacheClient
     ...
     */
    public AmazonElastiCacheAsyncClient(LunacloudCredentials awsCredentials) {
     ...
     *            be executed.
     */
    public AmazonElastiCacheAsyncClient(LunacloudCredentials awsCredentials, ExecutorService executorService) {
     ...
     */
    public AmazonElastiCacheAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *            be executed.
     */
    public AmazonElastiCacheAsyncClient(LunacloudCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
