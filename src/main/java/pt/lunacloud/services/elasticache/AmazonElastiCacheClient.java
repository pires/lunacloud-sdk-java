 ...
 */
package pt.lunacloud.services.elasticache;
...
import pt.lunacloud.services.elasticache.model.transform.*;
...
public class AmazonElastiCacheClient extends AmazonWebServiceClient implements AmazonElastiCache {
     ...
     */
    public AmazonElastiCacheClient(LunacloudCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonElastiCacheClient(LunacloudCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public AmazonElastiCacheClient(LunacloudCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public AmazonElastiCacheClient(LunacloudCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
