 ...
 * <p>
 * Calls to {@link STSSessionCredentials#getLunacloudAccessKeyId()},
 * {@link STSSessionCredentials#getLunacloudSecretKey()}, and
...
public class STSSessionCredentials implements AWSRefreshableSessionCredentials {
     ...
     */
    public STSSessionCredentials(LunacloudCredentials credentials) {
	 ...
	 */
    public STSSessionCredentials(LunacloudCredentials credentials, int sessionDurationSeconds) {
     ...
     */
    public synchronized String getLunacloudAccessKeyId() {
     ...
     * {@link RenewableAWSSessionCredentials#getImmutableCredentials()} as a proxy to this method.
     */
    public synchronized String getLunacloudSecretKey() {
