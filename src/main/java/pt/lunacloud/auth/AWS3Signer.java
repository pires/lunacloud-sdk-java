...
public class AWS3Signer extends AbstractAWSSigner {
    ...
    public void sign(Request<?> request, LunacloudCredentials credentials) throws LunacloudClientException {
        ...
        String signature = signAndBase64Encode(bytesToSign, sanitizedCredentials.getLunacloudSecretKey(), algorithm);

        StringBuilder builder = new StringBuilder();
        builder.append(isHttps ? HTTPS_SCHEME : HTTP_SCHEME).append(" ");
        builder.append("AWSAccessKeyId=" + sanitizedCredentials.getLunacloudAccessKeyId() + ",");
