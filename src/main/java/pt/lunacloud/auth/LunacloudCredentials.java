 ...
 */
public interface LunacloudCredentials {

    /**
     * Returns the Lunacloud access key ID for this credentials object. 
     * 
     * @return The Lunacloud access key ID for this credentials object. 
     */
    public String getLunacloudAccessKeyId();

    /**
     * Returns the Lunacloud secret access key for this credentials object.
     * 
     * @return The Lunacloud secret access key for this credentials object.
     */
    public String getLunacloudSecretKey();
