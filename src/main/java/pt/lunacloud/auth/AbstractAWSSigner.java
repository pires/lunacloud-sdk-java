...
public abstract class AbstractAWSSigner implements Signer {
     ...
     */
    protected LunacloudCredentials sanitizeCredentials(LunacloudCredentials credentials) {
        String accessKeyId = null;
        String secretKey   = null;
        String token = null;
        synchronized (credentials) {
            accessKeyId = credentials.getLunacloudAccessKeyId();
            secretKey   = credentials.getLunacloudSecretKey();
