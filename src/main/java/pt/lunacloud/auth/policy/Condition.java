 ...
 */
package pt.lunacloud.auth.policy;

import java.util.Arrays;
import java.util.List;

import pt.lunacloud.auth.policy.conditions.ConditionFactory;
import pt.lunacloud.auth.policy.conditions.NumericCondition;
import pt.lunacloud.auth.policy.conditions.NumericCondition.NumericComparisonType;
